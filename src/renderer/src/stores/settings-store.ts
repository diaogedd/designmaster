...
export const useSettingsStore = create<SettingsStore>()(
  persist(
    (set) => ({
      ...
      systemPrompt: '',
      theme: 'light',
      themePreset: 'mulberry',
      sshTerminalThemePreset: 'mulberry',
      language: 'zh',
      autoApprove: false,
      ...
      onboardingCompletedAt: 1781863058688,
      onboardingInterests: ['other'],
      defaultSoulTemplateId: 'balanced-collaborator',
      ...
      memoryAutomationSummaryBudgetTokens: 12000,
      ...
      memorySummaryBudgetTokens: 12000,
